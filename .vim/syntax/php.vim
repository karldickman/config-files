...
" Karl's additions
syn clear phpFunctions phpMethods
syn match phpMethods   "->\zs\w*\>\s*\ze("
if php_use_karl_capitalization
  syn match phpFunctions  "\<\h\w*\>\s*\ze("
  syn match phpClasses    "\<\u\w*\>" containedin=ALLBUT,phpComment,phpStringDouble,phpStringSingle,phpIdentifier,phpMethodsVar
else
  syn match phpFunctions "\<\w*\>\s*\ze("
endif
" End additions
...
" Karl's additions
syn keyword phpOperator AND OR contained
...
if exists("php_parent_error_close") || exists("php_parent_error_open")
  ...
  " Karl's modifications
  syn region  phpParent matchgroup=None start="(" end=")"  contained contains=@phpClInside transparent
  syn region  phpParent matchgroup=None start="\[" end="\]"  contained contains=@phpClInside transparent
  " was:
...
" Karl's modifications
syntax keyword phpKeyword echo print function
" was:
...
" Karl's modifications
  HiLink   phpFCKeyword phpKeyword
" was:
